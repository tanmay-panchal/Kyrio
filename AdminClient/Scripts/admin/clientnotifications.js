$(function () {
    ...
    //lay setting
    $.RequestAjax("/AdminSetting/GetBusinessSetting", JSON.stringify({
    ...
    $("#preview_confirmation, #preview_sms_reminder, #preview_reminder, #preview_rescheduling, #preview_cancellation, #preview_thank_you").click(function () {
        ...
        $.RequestAjax("/AdminSetting/PreviewTemplateNotification", JSON.stringify({
            template: template,
        }), function (data) {
    ...
    Ladda.bind('#excuteButton', {
        callback: function (instance) {
            ...
            if ($("#busiessForm").valid()) {
                ...
                $.ajax({
                    url: "/AdminSetting/SaveBusinessSettings",
                    type: 'post',
                    datatype: 'json',
