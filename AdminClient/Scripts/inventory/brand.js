...
$(function () {
    ...
    loaddata();
    $("#containtButtonCreate").InStallButtonFooter("buttonCreate", "tittleButton", "New Brand");
    $('#actionForm').validate({
        rules: {
            BrandName: 'required'
        },
    ...
    Ladda.bind('#actionButton', {
        callback: function (instance) {
            ...
            if ($("#actionForm").valid()) {
                ...
                $("form").AddOrUpdateForm("/Inventory/SaveBrand", success);
            } else
                instance.stop();
        }
    });
